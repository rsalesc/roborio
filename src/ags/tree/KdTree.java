...
/**
 * An efficient well-optimized kd-knn
 * 
 * @author Rednaxela
 */
public abstract class KdTree<T> {
    ...
    /**
     * Get the number of points in the knn
     */
    public int size() {
    ...
    /**
     * Add a point and associated value to the knn
     */
    ...
    /**
     * Remove the oldest value from the knn. Note: This cannot trim the bounds
     * of nodes, nor empty nodes, and thus you can't expect it to perfectly
     * preserve the speed of the knn as you keep adding.
     */
    ...
    public List<Entry<T>> nearestNeighbor(double[] location, int count, boolean sequentialSorting) {
        ...
        do {
            if (cursor.status == Status.ALLVISITED) {
                // At a fully visited part. Move up the knn
                cursor = cursor.parent;
                continue;
            }
    ...
    /**
     * Class for knn with Weighted Squared Euclidean distancing
     */
    ...
    /**
     * Class for knn with Unweighted Squared Euclidean distancing
     */
    ...
    /**
     * Class for knn with Weighted Manhattan distancing
     */
    ...
    /**
     * Class for knn with Manhattan distancing
     */
